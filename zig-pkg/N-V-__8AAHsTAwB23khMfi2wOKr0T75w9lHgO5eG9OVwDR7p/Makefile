...
install: lib
	...
	install -o 0 -g 0 -m 0644 libhydrogen.h $(PREFIX)/include 2> /dev/null || install -m 0644 libhydrogen.h $(PREFIX)/include
	ldconfig 2> /dev/null || true

uninstall:
	rm -f $(PREFIX)/lib/libhydrogen.a
	rm -f $(PREFIX)/include/libhydrogen.h
...
tests/tests: $(SRC) tests/tests.c
	$(CC) $(CFLAGS) -O3 -o tests/tests libhydrogen.c tests/tests.c
